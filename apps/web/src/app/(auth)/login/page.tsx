          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                disabled={isLoading}
                className="h-12 bg-gray-50 border-gray-200 focus:border-cyan-500 focus:ring-cyan-500"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  disabled={isLoading}
                  className="h-12 bg-gray-50 border-gray-200 focus:border-cyan-500 focus:ring-cyan-500 pr-12"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white font-medium text-base shadow-lg hover:shadow-xl transition-all"
            >

...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "record_id_mappings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"execution_id" varchar(255) NOT NULL,
	"project_id" uuid NOT NULL,
	"table_name" varchar(255) NOT NULL,
	"source_id" varchar(500) NOT NULL,
	"source_id_column" varchar(255) NOT NULL,
	"target_id" uuid NOT NULL,
	"target_id_column" varchar(255) DEFAULT 'id' NOT NULL,
	"couchdb_document_id" varchar(500),
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "unique_record_mapping" UNIQUE("execution_id","table_name","source_id")
);
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_record_mappings_execution" ON "record_id_mappings" ("execution_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_record_mappings_project" ON "record_id_mappings" ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_record_mappings_source" ON "record_id_mappings" ("source_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_record_mappings_target" ON "record_id_mappings" ("target_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_record_mappings_couchdb" ON "record_id_mappings" ("couchdb_document_id");--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "record_id_mappings" ADD CONSTRAINT "record_id_mappings_project_id_mapping_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "mapping_projects"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
